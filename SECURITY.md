...
The CodeGate community take security seriously! We appreciate your efforts to
...
["Report a Vulnerability"](https://github.com/stacklok/codegate/security/advisories/new)
tab.
...
The CodeGate community asks that all suspected vulnerabilities be handled in
accordance with
...
For each vulnerability, the CodeGate security team will coordinate to create the
...
- Create a new
  ...
  `https://github.com/stacklok/codegate/security/advisories/new`
...
- A link to fix will be posted to the
  [Stacklok Discord Server](https://discord.gg/stacklok) in the #codegate
  channel.
